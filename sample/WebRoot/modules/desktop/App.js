...
Ext.define('MyDesktop.App', {
    ...
    getModules : function(){
        ...
        Ext.each(modelDatas,function(item){
            modules.push(new Ext.easy.BaseModule(Ext.apply(item,{id:item.type})));
        });
        return modules;
    ...
    getStartConfig : function() {
        ...
        return Ext.apply(ret, {
            title: '欢迎您, ' + c_privileges.loginUser + ' ,今天是 ' + Ext.util.Format.date(new Date(),'Y-m-d'),
            iconCls: 'user',
            height: 300,
            toolConfig: {
                width: 100,
