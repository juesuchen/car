...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    shortcutTpl: [
        '<tpl for=".">',
            '<div class="ux-desktop-shortcut" id="{name}-shortcut" style="float: left;">',
                '<div class="ux-desktop-shortcut-icon {type}-shortcut">',
    ...
    onShortcutItemClick: function (dataView, record) {
        var me = this, module = me.app.getModule(record.data.type),
